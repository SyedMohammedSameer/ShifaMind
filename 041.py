#!/usr/bin/env python3
"""
ShifaMind 041: TARGETED Concept Loading Version (FIXED)

CRITICAL FIX:
Instead of loading random 30k concepts and hoping symptoms are included,
this version SEARCHES the entire UMLS database for specific medical terms.

BUGS FIXED:
1. Model classes defined BEFORE training code
2. Proper variable naming (labeler vs diagnosis_labeler)
3. No duplicate label generation
4. Correct initialization sequence

Author: Mohammed Sameer Syed
Date: November 2025
Version: 041-Targeted-Fixed
"""
...
print("="*80)
print("SHIFAMIND 041: TARGETED CONCEPT LOADING VERSION (FIXED)")
print("="*80)
...
umls_concepts, term_to_cuis, dx_coverage = targeted_loader.load_specific_concepts(REQUIRED_MEDICAL_TERMS)

print(f"\n✅ TARGETED LOADING COMPLETE:")
print(f"   Total concepts loaded: {len(umls_concepts)}")
print(f"   Guaranteed to contain required medical terms")
...
class OutputManager:
    ...
    def generate_report(self, results: dict):
        ...
        with open(report_path, 'w') as f:
            f.write("# ShifaMind 041 - Targeted Loading Results\n\n")
