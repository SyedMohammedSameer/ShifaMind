...
"""
        ...
        json_output = {
            ...
            'metadata': {
                'model_version': 'ShifaMind-043-Filtered',
...
with gr.Blocks(
    title="ShifaMind 043 - Filtered",
    theme=gr.themes.Soft()
) as demo:
    
    gr.Markdown("""
    # 🏥 ShifaMind 043: Clinical AI with Evidence & Knowledge
    ...
    **Supported Diagnoses:**
    ...
    gr.Markdown("""
    ---
    **Model**: ShifaMind-043-Filtered | **Performance**: F1 0.8010, AUROC 0.9122 | **Concepts**: Human medicine only  
